...
1. **Create a remote to track the base corocoto/conversify repository**
   ...
   (more on that shortly).  You would execute something like:
        ...
        git remote add base git://github.com/corocoto/conversify.git
...
4. **Make your changes**
   ...
   Create a separate branch for each unrelated changeset.
